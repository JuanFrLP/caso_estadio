...
namespace BoletoEstadio 
{
    class Program 
    {
        ...
        static void GenerarBoleto()
        {
            ...
            if (insertado)
            {
                Console.WriteLine("boleto generado correctamente");
                Console.WriteLine("ID: " + id + " | Codigo: " + hash.ToString("D8"));
            }
            else
            {
                Console.WriteLine("error, limite de capacidad alcanzado, no se puede generar mas boletos"); 
            }
        }
        ...
        static void ValidarBoleto()
        {
            ...
            {
                Console.WriteLine("error, ID invalido tiene que ser un numero entero positivo");
                return;
            }
            ...
            do
            {
                ...
                if (espacioOcupado[indice] && idOriginal[indice] == id)
                {
                    ...
                    else
                    {
                        ...
                        Console.WriteLine("Boleto valido, puede ingresar al estadio");
                    }
                    break;
                }
